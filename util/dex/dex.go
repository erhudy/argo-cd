...
func NewDexHTTPReverseProxy(serverAddr string, baseHRef string, tlsConfig *DexTLSConfig, encryptionKey []byte) func(writer http.ResponseWriter, request *http.Request) {
